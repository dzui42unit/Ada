...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#a46a89f5#;
   ...
   u00104 : constant Version_32 := 16#51bcb135#;
   pragma Export (C, u00104, "ada__synchronous_task_controlB");
   u00105 : constant Version_32 := 16#ab419d38#;
   pragma Export (C, u00105, "ada__synchronous_task_controlS");
   u00106 : constant Version_32 := 16#d81a47c0#;
   pragma Export (C, u00106, "system__task_primitivesS");
   u00107 : constant Version_32 := 16#2dd04756#;
   pragma Export (C, u00107, "system__os_interfaceS");
   u00108 : constant Version_32 := 16#f5163a3e#;
   ...
   u00110 : constant Version_32 := 16#ce7de326#;
   pragma Export (C, u00110, "system__win32S");
   u00111 : constant Version_32 := 16#3dfacd19#;
   pragma Export (C, u00111, "system__task_primitives__operationsB");
   u00112 : constant Version_32 := 16#26d8e313#;
   ...
   u00114 : constant Version_32 := 16#cd59d304#;
   pragma Export (C, u00114, "system__float_controlS");
   u00115 : constant Version_32 := 16#da8ccc08#;
   pragma Export (C, u00115, "system__interrupt_managementB");
   u00116 : constant Version_32 := 16#1065b90c#;
   pragma Export (C, u00116, "system__interrupt_managementS");
   u00117 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00117, "system__multiprocessorsB");
   u00118 : constant Version_32 := 16#15090f4b#;
   pragma Export (C, u00118, "system__multiprocessorsS");
   u00119 : constant Version_32 := 16#a99e1d66#;
   pragma Export (C, u00119, "system__os_primitivesB");
   u00120 : constant Version_32 := 16#a72a814e#;
   pragma Export (C, u00120, "system__os_primitivesS");
   u00121 : constant Version_32 := 16#b6166bc6#;
   pragma Export (C, u00121, "system__task_lockB");
   u00122 : constant Version_32 := 16#4c2fa756#;
   pragma Export (C, u00122, "system__task_lockS");
   u00123 : constant Version_32 := 16#1a9147da#;
   pragma Export (C, u00123, "system__win32__extS");
   u00124 : constant Version_32 := 16#77769007#;
   pragma Export (C, u00124, "system__task_infoB");
   u00125 : constant Version_32 := 16#fa4399cf#;
   pragma Export (C, u00125, "system__task_infoS");
   u00126 : constant Version_32 := 16#c75141ac#;
   pragma Export (C, u00126, "system__taskingB");
   u00127 : constant Version_32 := 16#a52e3c8f#;
   pragma Export (C, u00127, "system__taskingS");
   u00128 : constant Version_32 := 16#118e865d#;
   pragma Export (C, u00128, "system__stack_usageB");
   u00129 : constant Version_32 := 16#2b675f35#;
   pragma Export (C, u00129, "system__stack_usageS");
   u00130 : constant Version_32 := 16#d7aac20c#;
   pragma Export (C, u00130, "system__ioB");
   u00131 : constant Version_32 := 16#b3e76777#;
   pragma Export (C, u00131, "system__ioS");
   u00132 : constant Version_32 := 16#68810f22#;
   ...
   u00135 : constant Version_32 := 16#2f0547e8#;
   pragma Export (C, u00135, "system__concat_2S");
   u00136 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00136, "system__concat_3B");
   u00137 : constant Version_32 := 16#26d5cc9d#;
   pragma Export (C, u00137, "system__concat_3S");
   u00138 : constant Version_32 := 16#d0432c8d#;
   pragma Export (C, u00138, "system__img_enum_newB");
   u00139 : constant Version_32 := 16#4ce996f8#;
   pragma Export (C, u00139, "system__img_enum_newS");
   u00140 : constant Version_32 := 16#2a91f270#;
   pragma Export (C, u00140, "ada__task_identificationB");
   u00141 : constant Version_32 := 16#7518b2b2#;
   pragma Export (C, u00141, "ada__task_identificationS");
   u00142 : constant Version_32 := 16#05f5974e#;
   pragma Export (C, u00142, "system__tasking__utilitiesB");
   u00143 : constant Version_32 := 16#deb05b52#;
   pragma Export (C, u00143, "system__tasking__utilitiesS");
   u00144 : constant Version_32 := 16#9c40c6fd#;
   pragma Export (C, u00144, "system__tasking__initializationB");
   u00145 : constant Version_32 := 16#ed62fcff#;
   pragma Export (C, u00145, "system__tasking__initializationS");
   u00146 : constant Version_32 := 16#8cbc61ab#;
   pragma Export (C, u00146, "system__soft_links__taskingB");
   u00147 : constant Version_32 := 16#5ae92880#;
   ...
   u00149 : constant Version_32 := 16#e1d7566f#;
   pragma Export (C, u00149, "ada__exceptions__is_null_occurrenceS");
   u00150 : constant Version_32 := 16#1b84470b#;
   pragma Export (C, u00150, "system__tasking__task_attributesB");
   u00151 : constant Version_32 := 16#a1da3c09#;
   pragma Export (C, u00151, "system__tasking__task_attributesS");
   u00152 : constant Version_32 := 16#57df25b5#;
   pragma Export (C, u00152, "system__tasking__queuingB");
   u00153 : constant Version_32 := 16#05e644a6#;
   pragma Export (C, u00153, "system__tasking__queuingS");
   u00154 : constant Version_32 := 16#9a283644#;
   pragma Export (C, u00154, "system__tasking__protected_objectsB");
   u00155 : constant Version_32 := 16#5744f344#;
   pragma Export (C, u00155, "system__tasking__protected_objectsS");
   u00156 : constant Version_32 := 16#ee80728a#;
   pragma Export (C, u00156, "system__tracesB");
   u00157 : constant Version_32 := 16#dfb8f892#;
   pragma Export (C, u00157, "system__tracesS");
   u00158 : constant Version_32 := 16#fdb2ef41#;
   pragma Export (C, u00158, "system__tasking__protected_objects__entriesB");
   u00159 : constant Version_32 := 16#a0c7bfc6#;
   ...
   u00161 : constant Version_32 := 16#3626c63c#;
   ...
   u00163 : constant Version_32 := 16#0b40d4b2#;
